...
printfn "rotate branch 1a : rotate (create 3u) -1 : %5b" <| (rotate.rotate (rotate.create 3u) -1 = ['a'; 'b'; 'c'; 'd'; 'e'; 'f'; 'g'; 'h'; 'i'])
printfn "rotate branch 1a : rotate (create 3u) 0 : %5b" <| (rotate.rotate (rotate.create 3u) 0 = ['a'; 'b'; 'c'; 'd'; 'e'; 'f'; 'g'; 'h'; 'i'])
printfn "rotate branch 2a : rotate (create 3u) 3 : %5b" <| (rotate.rotate (rotate.create 3u) 3 = ['a'; 'b'; 'c'; 'd'; 'e'; 'f'; 'g'; 'h'; 'i'])
printfn "rotate branch 2a : rotate (create 3u) 6 : %5b" <| (rotate.rotate (rotate.create 3u) 6 = ['a'; 'b'; 'c'; 'd'; 'e'; 'f'; 'g'; 'h'; 'i'])
printfn "rotate branch 2a : rotate (create 3u) 7 : %5b" <| (rotate.rotate (rotate.create 3u) 7 = ['a'; 'b'; 'c'; 'd'; 'e'; 'f'; 'g'; 'h'; 'i'])
