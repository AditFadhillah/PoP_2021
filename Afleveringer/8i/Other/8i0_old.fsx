    ...
    for x = 0 to b-1 do
        for y = 0 to h-1 do
            match colorAt (x,y) figur with
                |None -> ImgUtil.setPixel (ImgUtil.fromRgb (128,128,128)) (x,y) C
                |Some col -> ImgUtil.setPixel col (x,y) C
...
///<summary> Funktionen checkFigure returnerer to punkter der betegner øverste venstre hjørne og 
/// nedeste højre hjørne af den mindste akserette rektangel, der indeholder hele figuren </summary>
///<example> Kaldet <c>boundingBox figurA </c> returnerer en rektangel der indeholder figurA </example>
///<param name="figure"> inputtet er en figur/ flere figurer som kan enten være cirkler eller rektangler, bestemmes af typen figure </param>
